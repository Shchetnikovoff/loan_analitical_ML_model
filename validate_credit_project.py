...
def main():
    print("=" * 60)
    print("CREDIT RISK PREDICTION PROJECT - VALIDATION")
    print("=" * 60)
    ...
    if not os.path.exists(TRAIN_PATH) or not os.path.exists(TEST_PATH):
        ...
        print("Note: This validation requires actual credit risk data files")
        return
    ...
    try:
        ...
        print(f"   - Credit risk classes: {list(label_encoder.classes_)}")
    ...
    print(f"   - Includes credit risk prediction interface")
